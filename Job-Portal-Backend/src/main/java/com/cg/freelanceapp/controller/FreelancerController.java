...
public class FreelancerController {
	...
	@GetMapping("/getSkillsByFreelancerId/{id}")
	public ResponseEntity<Object> getSkillsByFreelancerId(@PathVariable Long id){
		return new ResponseEntity<>(freelancerService.listSkillNames(id), HttpStatus.OK);
	}
}